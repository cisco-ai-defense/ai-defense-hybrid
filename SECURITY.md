...
`ai-defense-hybrid-deploy` project.
...
The `ai-defense-hybrid-deploy` maintainers take all security issues in the project
seriously. Thank you for improving the security of `ai-defense-hybrid-deploy`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`ai-defense-hybrid-deploy` leverages GitHub's private vulnerability reporting.
